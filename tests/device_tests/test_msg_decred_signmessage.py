...
class TestMsgDecredSignmessage(common.DecredTrezorTest):

    def test_sign(self):
        self.setup_mnemonic_nopin_nopassphrase()
        sig = self.client.decred_sign_message([], "Waldo was here")
        self.assertEqual(sig.address, 'DspDtjHb9aMymZzZjheNUjoPax3eWtrqaQf')
        self.assertEqual(binascii.hexlify(sig.signature), b'1f559545e02c6da69c7e6fd91c35685e166b8faad7cf9a75ed598ff0247d733d451e98bc6fadd7381b3ef657738089736f80c9837c3caba16606954a5bc6e84b72')

    # def test_sign_testnet(self):
    #     self.setup_mnemonic_nopin_nopassphrase()
    #     sig = self.client.decred_sign_message([0], "This is an example of a signed message.")
    #
